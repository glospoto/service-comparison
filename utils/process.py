...
"""
This class implements a wrapper to execute independent processes into bash. Currently, this class 
wraps subprocess.Popen object
"""
...
class Process(object):
	...
	'''
	Execute a commando into a bash terminal. By default both stdout and stderr will be redirect on 
	/dev/null.
	'''
	...
	def execute(self, command, shell=True, stdout=PIPE, stderr=PIPE):
		...
		# TODO Move inside this method the Popen.communicate() or Popen.wait() functions invoked 
		# on the current process
		# TODO based on the content of stdout parameter (stdout=PIPE -> communicate; 
		# stdout=None -> wait.)
