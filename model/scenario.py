...
"""
This class models a basic scenario object. A scenario is a collection of information defined in the 
configuration file; through the manipulation of those information, this class will be able to run 
