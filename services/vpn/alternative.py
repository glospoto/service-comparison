...
from services.vpn.scenario import Rm3SdnVpnScenario, MplsBgpVpnScenario
...
class Rm3SdnVpnAlternative(Alternative):
    def __init__(self, name, **kwargs):
        ...
        self._scenario = Rm3SdnVpnScenario(**kwargs)
    ...
    def create_scenario(self):
        ...
        self._configurator.configure(self._overlay, self._scenario)
        # Start the controller
        self._scenario.start_controller()
