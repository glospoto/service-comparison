...
"""
This class implements a custom switch that can be associated to the Mininet instance. A CustomSwitch is based on
a standard OVVSwitch object defined into Mininet API.
"""
